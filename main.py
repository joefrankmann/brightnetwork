...
def job_recomendation(members_data, jobs_data):
    ...
    for member in members:
        ...
        for job in jobs:
            ...
            if (
                job_location == member_preferences["location"]
                and job_title in member_preferences["job_title"]
            ):
...
if __name__ == "__main__":
    job_recomendation(members_data, jobs_data)
